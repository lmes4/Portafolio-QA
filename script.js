...
const SUPABASE_URL = 'https://nodpwmltalmdmxjgdpqy.supabase.co/rest/v1/form';
const SUPABASE_API_KEY = 'sb_publishable_OYYfof0RwlCnZn6RsmGq3A_Zpnr1NwK';
...
function enviarFormulario(event) {
  ...
  var data = {
    name: document.getElementById('name').value, //campo name de la api, se obtiene del input del formulario con id name
    email: document.getElementById('email').value, //campo email de la api, se obtiene del input del formulario con id email
    subject: document.getElementById('subject').value, //campo subject de la api, se obtiene del input del formulario con id subject
    message: document.getElementById('message').value //campo message de la api, se obtiene del input del formulario con id message
  }
  postAPI(data);
